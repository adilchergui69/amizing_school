...
try {
    ...
    //Recipients
    $mail->setFrom('cherguiadil1999@gmail.com', 'amazing school');
    $mail->addAddress('adilpaypal2019@gmail.com', 'adil chergui');     //Add a recipient
    ...
    if (isset($_POST["submit_demo"])&& isset($_POST["email"])&& isset($_POST["name"])&& isset($_POST["phone_number"])) {
    ...
    if (isset($_POST["submit_contact"])&& isset($_POST["name_contact"])&& isset($_POST["email_contact"])&& isset($_POST["message_contact"])) {
